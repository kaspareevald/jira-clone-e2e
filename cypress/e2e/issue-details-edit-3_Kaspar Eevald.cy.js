...
import IssueDetailsEdit from "../pages/IssueDetailsEdit-3"
...
describe('Issue details editing', () => {
  ...
  it('Should update type, status, assignees, reporter, priority successfully', () => {
    ...
    IssueDetailsEdit.updateIssue();

  })

  /* Old codes without classes here:
...
it.only('Should update title, description successfully', () => {
  ...
  IssueDetailsEdit.updateTitle()
  // IssueDetailsEdit.selectDescriptionField()
  IssueDetailsEdit.updateDescription()
  IssueDetailsEdit.saveIssue()
